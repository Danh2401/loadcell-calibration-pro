  ...
  const chartData = useMemo(() => {
    ...
    return history
      ...
      .map(h => ({
        ...
        diff: Number(((h.load.l1 as number + h.load.l2 as number + h.load.l3 as number + h.load.l4 as number) - (h.empty.l1 as number + h.empty.l2 as number + h.empty.l3 as number + h.empty.l4 as number)).toFixed(2))
      }))
